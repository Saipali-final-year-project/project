...
(1, 'm3', 'm', 'jamil@gmail.com', '', 4567, '', NULL, 'dfg', 4, 'dvbv', 'xcvb', 'xcv', 'xcv', 'Open this select menu', '2024-02-14 11:18:40', 'inactive', '', '2024-02-14 11:18:40', '2024-02-15 13:15:49', '0000-00-00 00:00:00');
...
CREATE TABLE `tblseeker` (
  ...
  `status` varchar(20) NOT NULL DEFAULT 'inactive',
  `tablename` varchar(225) NOT NULL DEFAULT 'seeker',
  `activation_date` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tblseeker` (`id`, `firstname`, `lastname`, `email`, `mobile`, `photo`, `NIN`, `region`, `district`, `town`, `subcounty`, `password`, `collection`, `type`, `status`, `tablename`, `activation_date`, `updated_at`) VALUES
(3, 'Oren', 'Cameron', 'jifax@mailinator.com', '0756435678', 'face9.jpg', 'AETF567SV67SR4', 'Central', 'UAS456D', '100', 'B-', '$2y$10$WkiTu3yTuxcuhez6B1N.4uANB5z0MvnWr.K0k3nS/pgzwCGV0f1OW', 'Old Taxi Park', 0, 'inactive', 'seeker', '2023-08-29 21:46:51', '2024-01-10 16:33:12'),
(5, 'Molly3', 'Deleon', 'molly@gmail.com', '0708657456', 'face22.jpg', 'WER4455677QWWQ', 'Select', '720', '100', 'Molly3', '$2y$10$dIw2TaVQITt.uoeMwK3Bv.DWU1VeJma9lOtZseVzTKj1Mn4m08zOy', 'Open this select menu', 0, 'Inactive', 'seeker', '2023-08-30 10:30:10', '2024-02-14 12:52:41'),
(6, 'hrhr', 'ndn', 'jamil@gmail.com', '12345', NULL, 'dnmds', 'Central', 'dd', 'dd', 'dd', '$2y$10$yZrWBKeJESL8lllDGLFnq.fIYv90giHHf0t/tmtC/Yq3FxmTbKiXm', 'Entebbe Hospital', 0, 'active', 'seeker', '2024-02-15 11:27:59', '2024-02-15 13:19:59');
