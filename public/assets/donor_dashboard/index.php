...
require_once('C:/xampp2/htdocs/Blood-Bank system/db_connect.php');
...
<body class="app">   	
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
				...
				<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
					...
					<h1>Welcome, <?php echo isset($donor['first_name']) ? $donor['first_name'] : 'Donor'; ?>!</h1>
                        <h4 class="app-card-title">Donor Information</h4>
                    </div>
  ...
  Check if $donor is set and has the 'first_name' key -->
<!-- <h1>Welcome, <?php echo isset($donor['first_name']) ? $donor['first_name'] : 'Donor'; ?>!</h1>
<h3> Personal Information</h>

<?php if (isset($donor['first_name'])) : ?>
    <p><strong>Name:</strong> <?php echo $donor['first_name'] . ' ' . $donor['last_name']; ?></p>
    <p><strong>Email:</strong> <?php echo $donor['email']; ?></p>
    <p><strong>Age:</strong> <?php echo $donor['age']; ?></p>
    <p><strong>City:</strong> <?php echo $donor['city']; ?></p>
    <p><strong>Blood Type:</strong> <?php echo $donor['blood_type']; ?></p>

    <button class="btn"><a href="donor_more.php">Update</a></button>
   
<?php else : ?>
     Display an error message if no donor is found
    <p>Error: No donor found with the specified ID.</p>
<?php endif; ?>
        </div>
    </div>  -->
	    ...
	    <footer class="app-footer">
            ...
            <small class="copyright">Designed with <span class="sr-only">blood</span><i class="fas fa-heart" style="color: #fb866a;"></i> by <a class="app-link" href="http://themes.3rdwavemedia.com" target="_blank">blood</a> for developers</small>
...
<?php
        ...
        echo "Error: No donor found with the specified ID.";
    }
} else {
