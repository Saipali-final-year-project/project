            ...
            <div class="card-body">
                ...
                <div id='empTable' class='display dataTable'>
                    <div class="profile-personal-info pt-4">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                <h5 class="f-w-500">Client Name<span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                <h5 class="f-w-500">Client Contact<span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                <h5 class="f-w-500">PickUp Branch<span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <a href="<?= base_url('/transit') ?>" class="btn btn-primary">Back</a>
                        </div>
                    </div>
