                ...
                <div id='empTable' class='display dataTable'>
                    <div class="profile-personal-info pt-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= $branch['phone'] ?></span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= $branch['town'] ?>
                                </span>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                <h5 class="f-w-500">Sub county<span class="pull-right">:</span></h5>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= $branch['address'] ?>
                                </span>
                            </div>
                        </div>
                       
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <a href="<?= base_url('/orders') ?>" class="btn btn-primary">Back</a>
                        </div>
                    </div>
