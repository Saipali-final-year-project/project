...
<div class="container-fluid page-body-wrapper">
    ...
    margin-left: 5%; padding-left: 34%;">
        ...
        <div class="row mt-5">
            ...
            <form method="POST" action="<?= base_url('/Drivers/updateimage'. $driver['id']) ?>" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <div class="card shadow">
                    ...
                    <div class="card-body p-4">
                        <div class="form-group mb-3 has-validation">
                            ...
                            <input type="file" class="form-control <?php if ($validation->getError('image')) : ?>is-invalid<?php endif ?>" name="photo" />
