    ...
    margin-left: 5%; padding-left: 34%;">
            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Track Blood</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Track Blood</h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url("/parcel/show".$car['id']) ?>" class="btn btn-sm btn-dark"><i
                                            class="la la-eye"></i></a>
                                    <a href="<?= base_url("/parcel/edit".$car['id']) ?>"
                                        class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                    <a href="<?= base_url("/parcel/delete".$car['id']) ?>"
