                ...
                <div class="modal fade" id="add_branch">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="<?= base_url('/add_staff'); ?>">
                                <?= csrf_field() ?>
                                              ...
                                              <option selected>Open this select menu</option>
                                                <?php if (count($branches)) {
                                                    foreach ($branches as $branche) {
                                                        echo '<option value="' . $branche['Bname'] . '">' . $branche['Bname'] . '</option>';
                                                    }
                                                } ?>
                                            </select>
                ...
                <div class="table-responsive">
                    ...
                    <table id='empTable' class='display dataTable'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $bra['firstname'] ?><?= $bra['lastname'] ?></td>
                                <td><?= $bra['email'] ?></td>
                                <td><?= $bra['mobile'] ?></td>
                                <td><?= $bra['NIN'] ?></td>
                                <td><?= $bra['status'] ?></td>
                                <td>
                                    <a href="<?= base_url("/staff/show".$bra['id']) ?>" class="btn btn-sm btn-dark"><i
                                            class="la la-eye"></i></a>
                                    <a href="<?= base_url("/staff/edit".$bra['id']) ?>"
                                        class="btn btn-sm btn-primary"><i class="la la-pencil"></i></a>
                                    <a href="<?= base_url("/staff/delete".$bra['id']) ?>"
