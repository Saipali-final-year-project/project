...
<body class="h-100">
    ...
    <div class="authincation h-100 bg-danger">
    ...
    margin-left: 5%; padding-left: 24%;">
                    ...
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    <h4 class="text-center mb-4">Sign in <i class="devicons devicons-ruby_on_rails"></i> account</h4>
                                    <?php
    if (session()->getFlashdata('success')) : ?>
                                    ...
                                    <form action="<?php echo base_url('/login2'); ?>" method="post">
                                        ...
                                        <!-- <div class="form-row d-flex justify-content-between mt-4 mb-2">
                                            <div class="row" style="padding:15px;">
                                                <div class="col-lg-6 col-md-6 col-sm-12 google">
                                                    ...
                                                    <div class="form-group">
                                                        <a href="<?=$loginButton;?>"><img
                                                                src="<?= base_url();?>/assets/img/Google.png"
                                                                height='40px' alt="" srcset=""></a>
                                                    </div>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 facbook">
                                                    <div class="form-group">
                                                        <a href="http://" target="_blank"><img
                                                                src="<?= base_url();?>/assets/img/Facebook.jpg"
                                                                height='40px' alt="" srcset=""></a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <a href="<?php echo base_url('/forget-password'); ?>">Forgot
                                                    Password?</a>
                                            </div>
                                        </div> -->
