<!-- Limit to 5 Links each side of the current page -->
...
<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <?php if($total_res > 0): ?>
        <div class="fw-light fs-italic text-muted text-end">Showing <?= (($page1 * $perPage1) - $perPage1 +1) ."-". (($page1 * $perPage1) - $perPage1 + ($total_res1))  ?> Result out of <?= number_format($total1) ?></div>
        <?php endif; ?>
    </div>
