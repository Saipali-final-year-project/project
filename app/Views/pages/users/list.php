...
<div class="card rounded-0">
    <div class="card-header">
        <div class="d-flex w-100 justify-content-between">
            ...
            <div class="col-auto">
                <a href="<?= base_url('/user_add') ?>" class="btn btn btn-primary bg-gradient border rounded-0"><i class="fa fa-plus-square"></i> Add User</a>
            </div>
        </div>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    <?php foreach($users as $row): ?>
                        <tr>
                            ...
                            <td class="px-2 py-1 align-middle"><?= ($row['type'] == 1) ? 'Administrator' : 'Author' ?></td>
